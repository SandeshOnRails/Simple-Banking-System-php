<html>
<h1>Please provide the following details to Deposit</h1>
<h2> - Deposit Amount should be multiples of 20 (20, 40, 60 ....)</h2>
<h2> - Deposit Amount should not exceed 10000</h2>
    <hr>
<style>
...
<hr>
<input type="button" value ="Deposit" id ="balCheck" onclick ="validate()">
</form>
    </div>
        <p id="result"></p>
